...
type Match struct {
	...
	HomeTeam    *Team        `gorm:"foreignKey:HomeTeamID" json:"home_team,omitempty" form:"home_team" swaggerignore:"true"`
	AwayTeamID  uint64       `gorm:"index;not null" json:"away_team_id" form:"away_team_id" binding:"required"`
	AwayTeam    *Team        `gorm:"foreignKey:AwayTeamID" json:"away_team,omitempty" form:"away_team" swaggerignore:"true"`
	Lineups     []Lineup     `gorm:"foreignKey:MatchID" json:"lineups,omitempty" form:"lineups" swaggerignore:"true"`
	PlayerStats []PlayerStat `gorm:"foreignKey:MatchID" json:"player_stats,omitempty" swaggerignore:"true"`
